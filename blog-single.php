...
<body>
  ...
  $query = mysqli_query($c, "select * from all_jobs where job_id='$id'");
...
<body>
    <form action="apply_job.php" method="post" id="jobPortal" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-sm-6 form-group">
                <label for="dob">Enter Your Contact Number</label>
                <input type="tel" class="form-control" name="number" placeholder="Contact Number" required>
            </div>
            <div class="col-sm-6 form-group">
